...
wwv_flow_api.create_plugin(
 p_id=>wwv_flow_api.id(8764402351181493033)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(654855578420454198)
,p_plugin_id=>wwv_flow_api.id(8764402351181493033)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(654855913928454199)
,p_plugin_id=>wwv_flow_api.id(8764402351181493033)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(654856354464454199)
,p_plugin_id=>wwv_flow_api.id(8764402351181493033)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_std_attribute(
 p_id=>wwv_flow_api.id(654858268014454201)
,p_plugin_id=>wwv_flow_api.id(8764402351181493033)
,p_name=>'SOURCE_SQL'
,p_is_required=>false
...
wwv_flow_api.create_plugin_file(
 p_id=>wwv_flow_api.id(654858997846454201)
,p_plugin_id=>wwv_flow_api.id(8764402351181493033)
